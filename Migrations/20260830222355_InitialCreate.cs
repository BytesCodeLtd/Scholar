        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeaderFontStyle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    TextFormatting = table.Column<int>(type: "int", nullable: false),
                    HeadingFormatting = table.Column<int>(type: "int", nullable: false),
                    LineHeight = table.Column<decimal>(type: "decimal(3,1)", nullable: false),
                    PaperFontColor = table.Column<int>(type: "int", nullable: false),
                    EnglishTextFontStyle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Watermark = table.Column<int>(type: "int", nullable: false),
                    PicWatermarkOpacity = table.Column<decimal>(type: "decimal(3,1)", nullable: false),
                    PicWatermarkHeight = table.Column<int>(type: "int", nullable: false),
                    PicWatermarkWidth = table.Column<int>(type: "int", nullable: false),
                    LogoHeight = table.Column<int>(type: "int", nullable: false),
                    LogoWidth = table.Column<int>(type: "int", nullable: false),
                    McqsLayout = table.Column<int>(type: "int", nullable: false),
                    NumeralStyle = table.Column<int>(type: "int", nullable: false),
                    ...
                    ShowConceptualQuestionMark = table.Column<bool>(type: "bit", nullable: false),
                    HidePhoneNumber = table.Column<bool>(type: "bit", nullable: false),
                    QuestionHeadingBottomBorder = table.Column<bool>(type: "bit", nullable: false),
                    ShowChapterName = table.Column<bool>(type: "bit", nullable: false),
                    ShowGrammaticalTerms = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestSettings_Institutes_InstituteId",
                        column: x => x.InstituteId,
                        principalTable: "Institutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaperSettingsSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Test_Institutes_InstituteId",
                        column: x => x.InstituteId,
                        principalTable: "Institutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teacher_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestSections_Test_TestId",
                        column: x => x.TestId,
                        principalTable: "Test",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
                    TestSectionId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teacher_UserId_SubjectId_GradeId",
                table: "Teacher",
                columns: new[] { "UserId", "SubjectId", "GradeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestSettings_InstituteId",
                table: "TestSettings",
                column: "InstituteId",
                unique: true);
